...
# 04/21/17
#   * added more hosts
#   * Support for CEH home lab


# Physical ESXi host or vCenter Server to deploy vSphere 6.0 lab
$VIServer = "vcsa20.herrings.info"
$VIUsername = "admin@vsphere.local"
$VIPassword = "Password!"
...
$NestedESXiApplianceOVA = "Z:\VMware\vCloud6.0\vSphere-ESXi\Nested_ESXi6.x_Appliance_Template_v5.ova"
$VCSAInstallerPath = "Z:\VMware\vCloud6.0\vCenterServer\VMware-VCSA-all-6.0.0-3634788"

# Nested ESXi VMs to deploy
$NestedESXiHostnameToIPs = @{
"vesxi60-1" = "192.168.84.81"
"vesxi60-2" = "192.168.84.82"
"vesxi60-3" = "192.168.84.83"
"vesxi60-4" = "192.168.84.84"
"vesxi60-5" = "192.168.84.85"
"vesxi60-6" = "192.168.84.86"
"vesxi60-7" = "192.168.84.87"
"vesxi60-8" = "192.168.84.88"
"vesxi60-9" = "192.168.84.89"
"vesxi60-0" = "192.168.84.80"
}
...
$VCSAIPAddress = "192.168.84.50"
$VCSAHostname = "192.168.84.50" #Change to IP if you don't have valid DNS
$VCSAPrefix = "24"
$VCSASSODomainName = "vsphere.local"
$VCSASSOSiteName = "HNET-Site"
$VCSASSOPassword = "VMware1!"
$VCSARootPassword = "VMware1!"
$VCSASSHEnable = "true"

# General Deployment Configuration for both Nested ESXi VMs + VCSA
$VMNetwork = "LN10g_84 Test"
$VMDatastore = "jupiter_zvol1"
$VMNetmask = "255.255.255.0"
$VMGateway = "192.168.84.254"
$VMDNS = "192.168.98.21"
$VMNTP = "pool.ntp.org"
$VMPassword = "VMware1!"
$VMDomain = "virtuallab.info"
$VMSyslog = "192.168.98.48"
# Applicable to Nested ESXi only
$VMSSH = "true"
$VMVMFS = "false"

# Applicable to VC Deployment Target only
$VMCluster = "pCL-Site-A"
...
$VAppName = "vSphere-Lab-$vSphereVersion-$random_string"
